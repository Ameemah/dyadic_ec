...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='originalattempt1.py',
...
startexpComponents = [keystart, waitingforscanner, key_resp_1, key_resp_2, key_resp_3]
...
while continueRoutine:
    ...
    if keystart.status == STARTED and not waitOnFlip:
        theseKeys = keystart.getKeys(keyList=['t'], waitRelease=False)
    ...
    if key_resp_1.status == STARTED and not waitOnFlip:
        theseKeys = key_resp_1.getKeys(keyList=['1'], waitRelease=False)
    ...
    if key_resp_3.status == STARTED and not waitOnFlip:
        theseKeys = key_resp_3.getKeys(keyList=['3'], waitRelease=False)
