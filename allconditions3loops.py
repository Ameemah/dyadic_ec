...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='allconditions3loops.py',
...
ROLO = sound.Sound('rightopenleftopen.wav', secs=2.0, stereo=True, hamming=True,
    name='ROLO')
ROLO.setVolume(1.0)
...
RCLC = sound.Sound('rightcloseleftclose.wav', secs=2.0, stereo=True, hamming=True,
    name='RCLC')
RCLC.setVolume(1.0)
...
RCLO2 = sound.Sound('rightcloseleftopen1.wav', secs=2.0, stereo=True, hamming=True,
    name='RCLO2')
RCLO2.setVolume(1.0)
...
for thisLoop1 in Loop1:
    ...
    ROLO.setSound('rightopenleftopen.wav', secs=2.0, hamming=True)
    ...
    continueRoutine = True
    # update component parameters for each repeat
    RCLC.setSound('rightcloseleftclose.wav', secs=2.0, hamming=True)
...
for thisLoop3 in Loop3:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    RCLO2.setSound('rightcloseleftopen1.wav', secs=2.0, hamming=True)
